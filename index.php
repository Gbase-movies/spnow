...
if(isset($_GET['page'])){
$lastupdate = $APIbaseURL."/api/recently-added-sub?page=".$_GET['page'];
}
...
<title><?php echo $Title; ?> : Watch Korea videos from everywhere</title>
...
<div id="wrapper_bg" class="">
    ...
    <div class="top-header vc_col-sm-12">
        <div class="logo vc_col-sm-2">
            <a href="/">
            <img src="img/logo_vid.png?3" class="retina-header" alt="<?php echo $Title; ?> : - Watch Korea videos from everywhere" />            </a>
        </div>
...
<div class="main-inner">
    <div class="section-header">
        <h3 class="widget-title"><i class="fa fa-play"></i> <?php echo $RecentlyAddedSubTitle; ?></h3>
    </div>
