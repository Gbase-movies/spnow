...
include ('config.php');
// Latest Update RAW
$lastupdateraw = $APIbaseURL."/api/recently-added-raw";
if(isset($_GET['page'])){
$lastupdateraw = $APIbaseURL."/api/recently-added-raw?page=".$_GET['page'];
}
...
$ambil = file_get_contents($lastupdateraw, false, stream_context_create($arrContextOptions));
$latestraw = json_decode($ambil);
...
<title><?php echo $RecentlyAddedRawTitle; ?> : Watch Korea videos from everywhere</title>
...
<meta property="og:title" content="<?php echo $Title; ?> - Watch Korea videos from everywhere"/>
...
<meta property="twitter:title" content="<?php echo $Title; ?> - Watch Korea videos from everywhere"/>
<meta property="twitter:description" content="<?php echo $Title; ?> - Watch Korea videos from everywhere"/>

<link rel="canonical" href="/recently-added-raw"/>
<link rel="alternate" hreflang="en-us" href="/recently-added-raw"/>
...
<div id="wrapper_bg" class="">
    ...
    <div class="top-header vc_col-sm-12">
        <div class="logo vc_col-sm-2">
            <a href="/">
            <img src="/img/logo_vid.png?3" class="retina-header" alt="<?php echo $RecentlyAddedRawTitle; ?> : - Watch Korea videos from everywhere" /></a>
        </div>
...
<div id="navigation-wrapper">
    <div class="main-content">
        ...
        <ul id="menu-header-menu">
            ...
            <li class="active"><a href="/recently-added-raw"><?php echo $RecentlyAddedRawTitle; ?></a></li>
...
<div class="main-inner">
    <div class="section-header">
        <h3 class="widget-title"><i class="fa fa-play"></i> <?php echo $RecentlyAddedRawTitle; ?></h3>
    </div>
    <div class="clearfix"></div>
    <div class="vc_row wpb_row vc_row-fluid vc_custom_1404913114846">
        <div class="vc_col-sm-12 wpb_column column_container">
            <div class="wpb_wrapper">
                ...
                <?php foreach ($latestraw as $drama) : ?><li class="video-block ">
