...
include ('config.php'); 
// Ongoing Series
$ongoing = $APIbaseURL."/api/ongoing-series";
if(isset($_GET['page'])){
$ongoing = $APIbaseURL."/api/ongoing-series?page=".$_GET['page'];
}
...
$ambil = file_get_contents($ongoing, false, stream_context_create($arrContextOptions));
$ongoing = json_decode($ambil);
...
<title><?php echo $OngoingTitle; ?> : Watch Korea videos from everywhere</title>
...
<meta property="og:title" content="Ongoing Series - <?php echo $Title; ?> - Watch Korea videos from everywhere"/>
...
<meta property="twitter:title" content="Ongoing Series - <?php echo $Title; ?> - Watch Korea videos from everywhere"/>
<meta property="twitter:description" content="<?php echo $Title; ?> - Watch Korea videos from everywhere"/>

<link rel="canonical" href="/ongoing-series"/>
<link rel="alternate" hreflang="en-us" href="/ongoing-series"/>
...
<div id="wrapper_bg" class="">
    ...
    <div class="top-header vc_col-sm-12">
        <div class="logo vc_col-sm-2">
            <a href="/">
            <img src="/img/logo_vid.png?3" class="retina-header" alt="<?php echo $OngoingTitle; ?> : - Watch Korea videos from everywhere" />            </a>
        </div>
...
<div id="navigation-wrapper">
    <div class="main-content">
        ...
        <ul id="menu-header-menu">
            ...
            <li class="active"><a href="/ongoing-series"><?php echo $OngoingTitle; ?></a></li>
        </ul>
    </div>
</div>
<div class="clearfix"></div>
...
<div class="main-inner">
    <div class="section-header">
        <h3 class="widget-title"><i class="fa fa-play"></i> <?php echo $OngoingTitle; ?></h3>
    </div>
    <div class="clearfix"></div>
    <div class="vc_row wpb_row vc_row-fluid vc_custom_1404913114846">
        <div class="vc_col-sm-12 wpb_column column_container">
            <div class="wpb_wrapper">
                ...
                <?php foreach ($ongoing as $drama) : ?><li class="video-block ">
